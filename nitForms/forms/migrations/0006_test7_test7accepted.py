# Generated by Django 3.0.5 on 2020-12-02 16:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('forms', '0005_test6_test6accepted'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asdasfsdf', models.CharField(max_length=1000)),
                ('ertyery', models.CharField(max_length=1000)),
            ],
        ),
        migrations.CreateModel(
            name='test7Accepted',
