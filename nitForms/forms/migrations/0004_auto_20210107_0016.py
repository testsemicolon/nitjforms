# Generated by Django 3.0.7 on 2021-01-06 18:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='test2',
            name='sasa',
            field=models.CharField(default=datetime.datetime(2021, 1, 6, 18, 45, 54, 440540, tzinfo=utc), max_length=1000),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='test2',
            name='what_is_your_name',
            field=models.CharField(default=datetime.datetime(2021, 1, 6, 18, 46, 1, 720081, tzinfo=utc), max_length=1000),
            preserve_default=False,
        ),
    ]
