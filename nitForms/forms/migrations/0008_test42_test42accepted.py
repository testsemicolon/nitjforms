# Generated by Django 3.0.5 on 2020-10-31 01:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('forms', '0007_test32_test32accepted'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Enter_x', models.CharField(max_length=1000)),
                ('Enter_y', models.CharField(max_length=1000)),
            ],
        ),
        migrations.CreateModel(
            name='test42Accepted',
