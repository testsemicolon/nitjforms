# Generated by Django 3.0.7 on 2021-01-10 19:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('forms', '0006_teest5_teest5accepted'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('naaam', models.CharField(choices=[('ram', 'ram'), ('sham', 'sham'), ('ravi', 'ravi'), ('ran', 'ran')], max_length=1000)),
            ],
        ),
        migrations.CreateModel(
            name='chahatAccepted',
